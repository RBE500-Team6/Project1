...
def generate_launch_description():
    ...
    rrbot_gazebo = os.path.join(get_package_share_directory('rrbot_gazebo'),
                                'worlds', 'rrbot.world')
    ...
    xacro_file = os.path.join(rrbot_description_path, 'urdf',
                              'rrbot.urdf.xacro')
    ...
    robot_controllers = os.path.join(
        get_package_share_directory("rrbot_gazebo"), "config",
    ...
    nodes = [
        gazebo, spawn_entity, controller_manager, node_robot_state_publisher,
