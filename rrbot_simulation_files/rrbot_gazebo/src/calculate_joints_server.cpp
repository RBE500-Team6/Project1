...
void calculate_joints(
    const std::shared_ptr<rrbot_gazebo::srv::CalculateJoints::Request> request,
  ...
  RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "sending back response: [%f %f %f]",
              response->q0, response->q1, response->q2);
}
